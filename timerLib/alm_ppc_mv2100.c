...
#define BASE           0xfcf40000

#define TIMER3_INT_VEC 0x3

#include "alm_ppcDec.c"        /* Generic PPC decrementer timer code */

/* Global pointer to the mv2100 timer function entry table. */
alm_func_tbl_ts *alm_ppc_mv2100_tbl_ps = &alm_ppcDecTbl_s;
